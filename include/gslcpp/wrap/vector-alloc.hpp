...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<double> *w_vector_alloc<double>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<float> *w_vector_alloc<float>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<long double> *w_vector_alloc<long double>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<int> *w_vector_alloc<int>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<unsigned> *w_vector_alloc<unsigned>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<long> *w_vector_alloc<long>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<unsigned long> *w_vector_alloc<unsigned long>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<short> *w_vector_alloc<short>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<unsigned short> *w_vector_alloc<unsigned short>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<char> *w_vector_alloc<char>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<unsigned char> *w_vector_alloc<unsigned char>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<gsl_complex> *w_vector_alloc<gsl_complex>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<gsl_complex_float> *w_vector_alloc<gsl_complex_float>(size_t n) {
...
/// @param n  Number of elements to allocate.
/// @return  Pointer to GSL's native C-struct for vector.
template<> w_vector<gsl_complex_long_double> *
w_vector_alloc<gsl_complex_long_double>(size_t n) {
