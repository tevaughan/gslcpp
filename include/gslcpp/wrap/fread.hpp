...
/// @param v  Pointer to vector that should be initialized from stream.
/// @return  0 on success or GSL_EFAILED on problem reading from stream.
inline int w_fread(FILE *f, w_vector<gsl_complex> *v) {
...
/// @param v  Pointer to vector that should be initialized from stream.
/// @return  0 on success or GSL_EFAILED on problem reading from stream.
inline int w_fread(FILE *f, w_vector<gsl_complex_float> *v) {
...
/// @param v  Pointer to vector that should be initialized from stream.
/// @return  0 on success or GSL_EFAILED on problem reading from stream.
inline int w_fread(FILE *f, w_vector<gsl_complex_long_double> *v) {
