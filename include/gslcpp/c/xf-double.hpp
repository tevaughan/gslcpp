...
template<> struct xf<double const> {
  ...
  static int fwrite(FILE *f, vector<double const> *v) {
  ...
  static double max(vector<double const> *v) { return gsl_vector_max(v); }
  ...
  static void minmax(vector<double const> *v, double *min, double *max) {
  ...
  static std::size_t max_index(vector<double const> *v) {
